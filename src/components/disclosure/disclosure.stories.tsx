...
const Template = (props: Disclosure["RootProps"]) => {
  ...
  return (
    <Box maxW="md" textAlign="center" width="full">
...
const ControlledTemplate = (props: Disclosure["RootProps"]) => {
  ...
  return (
    <Box maxW="md" spaceY="4" width="full">
      ...
      <Disclosure {...props} open={isOpen} onOpenChange={({open}) => setIsOpen(open)}>
        ...
        <Disclosure.Content>
          <Disclosure.Body style={{paddingTop: "0.5rem"}}>
            <Box borderWidth="1px" p="4" rounded="lg" spaceY="4">
              <Text as="h3" fontSize="lg" fontWeight="semibold">
                Product Details
              </Text>
              <Box display="grid" fontSize="sm" gap="2">
