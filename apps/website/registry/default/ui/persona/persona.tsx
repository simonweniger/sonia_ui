...
import type { PersonaVariantProps } from '@sonia/ui/slot-recipes/persona'
import { dataAttr } from '@sonia/ui/utils'
import { cx } from '@sonia/ui/utils'
 ...
 *
 * @see Docs https://sonia-ui.dev/docs/components/persona
 */
