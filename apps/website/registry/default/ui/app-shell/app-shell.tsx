...
export interface AppShellRootProps
  extends HTMLChakraProps<'div'>, SlotRecipeProps<'suiAppShell'> {}

/**
 * The App Shell defines the main structure of your app.
 *
 * @see Docs https://sonia-ui.dev/docs/components/layout/app-shell
 */
...
export interface AppShellProps
  extends AppShellBaseProps, HTMLChakraProps<'div'> {}
