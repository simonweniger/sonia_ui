          ...
          <Accordion.Root width="full" collapsible>
            <Accordion.Item value="1">
              <Accordion.ItemTrigger fontSize="md" fontWeight="medium">
                How many products can I use Sonia UI Pro for?
            ...
            <Accordion.Item value="2">
              <Accordion.ItemTrigger fontSize="md" fontWeight="medium">
                Does Sonia UI include Figma, Sketch or other design files?
              </Accordion.ItemTrigger>
              <Accordion.ItemContent fontSize="md">
            ...
            <Accordion.Item value="3">
              ...
              <Accordion.ItemContent fontSize="md">
                The Sonia UI Pro license is perpetual, you will have access to
                all assets of the Sonia UI Pro library forever.
              </Accordion.ItemContent>
            </Accordion.Item>
            ...
            <Accordion.Item value="4">
              ...
              <Accordion.ItemContent fontSize="md">
                ...
                support or consultancy contact us at hello@sonia-ui.dev
              </Accordion.ItemContent>
            </Accordion.Item>
          </Accordion.Root>
        </Stack>
