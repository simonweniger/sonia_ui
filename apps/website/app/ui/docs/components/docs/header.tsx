...
const SoniaUIIcon = () => (
  <svg width="24" height="24">
    <text y="18" fontSize="14" fontWeight="bold">
      S
    </text>
  </svg>
)
      ...
      <HStack py="2" minH="48px">
        <HStack width="300px">
          <HStack asChild>
            <Link href="/docs">
              <>
                <SoniaUIIcon color="black" width="24px" height="24px" />
        ...
        <HStack gap="0" justifyContent="flex-end">
          <IconButton asChild variant="ghost" size="sm" aria-label="Github">
            <Link href="https://github.com/saas-js/sonia-ui" target="_blank">
              <BsGithub />
            </Link>
          </IconButton>
          <ColorModeButton />
