...
export interface CanvasHeaderProps
  extends UiComponent, React.ComponentPropsWithoutRef<'div'> {
  state: string
        ...
        <HStack gap="1">
          ...
          {isAuthenticated && (
            <IconButton
              ...
              as="a"
              href={`https://github.com/saas-js/sonia-ui-pro/tree/main/packages/blocks/src/${attributes.category}/${slug}/${slug}.tsx`}
              target="_blank"
