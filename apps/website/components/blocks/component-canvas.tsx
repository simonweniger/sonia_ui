...
import * as UiComponents from 'sonia-ui-blocks'
import { UiComponent } from '@/blocks'

import { Box, Card, LoadingOverlay, Stack, defaultSystem } from '@sonia/ui'
...
export function ComponentCanvas(props: UiComponent & { zIndex: number }) {
  ...
  //   'primary'
  // )
  // const [themeId, setTheme] = useLocalStorage('theme.id', '@sonia/ui')
