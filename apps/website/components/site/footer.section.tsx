...
import { Box, Container, Heading, SimpleGrid, Stack, Text } from '@sonia/ui'
    ...
    items: [
      {
        ...
        href: 'https://sonia-ui.lemonsqueezy.com/affiliates?aff_ref=nB1mj6rB',
      },
      { label: 'Documentation', href: '/docs' },
      { label: 'Blog', href: '/blog' },
      { label: 'Roadmap', href: 'https://roadmap.sonia-ui.dev' },
        ...
        >
          <Stack align="flex-start" gap="4">
            ...
            <Text color="fg.subtle">
              Crafted by Sonia UI B.V. in the Netherlands &copy;{' '}
