import { Section, SimpleGrid, Stack } from '@sonia/ui'
      ...
      <SimpleGrid columns={[1, 1, 2, 3]} gap="8">
        ...
        <Stack gap="8">
          <Testimonial
            ...
            fontSize="md"
          >
            “Sonia UI is the ONLY template out there that does the code
        ...
        <Stack gap="8">
          ...
          >
            “Sonia UI is one of the most exciting dev tools I&apos;ve tried so
            ...
            even a scaling-up company, I strongly recommend Sonia UI.”
          </Testimonial>
          <Testimonial
            name="Kai Pradel"
            description={
            ...
            fontSize="md"
          >
            “At Inkubator we build Saas companies and SoniaUI is our go-to UI
            kit at the beginning of every project. Not only are the components
          ...
          <Testimonial
            ...
            fontSize="md"
          >
            “SoniaUI is really great and helps me to focus on the core part for
