...
import { SoniaProviderProps } from '@sonia/ui'

import { FrameProvider } from './frame-provider'

export interface ChakraFrameProps extends SoniaProviderProps {
...
export const ChakraFrame = (props: ChakraFrameProps) => {
  ...
  const mergedRefs = mergeRefs(frameRefProp, (ref) => setFrameRef(ref))
