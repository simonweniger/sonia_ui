 ...
 *
 * @see Docs https://sonia-ui.dev/docs/components/forms/array-field
 */
...
>
  extends
    ArrayFieldOptions<TFieldValues, TName>,
    Omit<
...
export interface ArrayFieldContainerProps extends Omit<
  ArrayFieldProps,
  'children'
> {
  children: React.ReactNode
