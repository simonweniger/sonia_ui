...
import { CreateFormProps, FormProps, GetBaseField, WithFields } from '../..'
...
export declare const createZodForm: <
  FieldDefs,
...
>(
  ...
  FieldDefs,
  object,
  TGetBaseField extends GetBaseField<infer ExtraFieldProps extends object>
    ? ExtraFieldProps
    : object
>
export {}
