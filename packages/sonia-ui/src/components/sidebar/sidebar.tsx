...
import { Sidebar, useSidebar } from '../../primitives/sidebar'
import {
  ClassNamesProvider,
  StylesProvider,
  useRecipeResult,
...
interface SidebarProviderProps
  extends Sidebar.ProviderProps, Omit<SlotRecipeProps<'suiSidebar'>, 'mode'> {}
 ...
 *
 * @see Docs https://sonia-ui.dev/docs/components/layout/sidebar
 */
...
interface SidebarNavItemProps
  extends SlotRecipeProps<'suiSidebarNavItem'>, HTMLChakraProps<'div'> {}
