...
export interface SoniaProviderProps extends ChakraProviderProps {
  linkComponent?: React.ElementType<any>
  children: React.ReactNode
}

export function SoniaProvider(props: SoniaProviderProps) {
  const { linkComponent, children, ...rest } = props
